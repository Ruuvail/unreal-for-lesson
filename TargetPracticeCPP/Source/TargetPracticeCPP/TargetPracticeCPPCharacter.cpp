...
void ATargetPracticeCPPCharacter::BeginPlay()
{
	...
	// TODO: I might refactor the input setup later (some inputs are temporarily disabled on purpose).
}
...
void ATargetPracticeCPPCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking
		// NOTE: I temporarily disabled the look input because I was getting a strange rotation bug.
		// I will re-enable this binding in the next assignment after I finish debugging it.
		//
